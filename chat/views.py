...
def chatbot(request):
    ...
    load = loader.get_template('chatbot.html')
    return HttpResponse(load.render({},request))
def get(request):
    import nltk
    ...
    def response(user_response):
        ...
        if(req_tfidf==0):
            ...
            return robo_response
    user_response = request.POST['queries']
    ...
    load = loader.get_template('response.html')
    return HttpResponse(load.render(request,context))
def back(request):
    return redirect('/')